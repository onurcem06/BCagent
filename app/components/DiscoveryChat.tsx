...
export default function DiscoveryChat() {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-900/40 backdrop-blur-2xl border-r border-slate-800/60 relative">
            {/* Header */}
            <div className="p-4 border-b border-slate-800/50 flex flex-col gap-1 bg-slate-900/20">
                ...
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Strategic Design Assistant</p>
            </div>
